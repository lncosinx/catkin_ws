...
用法：
  rosrun tly verify_camera_intrinsics.py                       # report + points(默认)
  rosrun tly verify_camera_intrinsics.py _mode:=report         # 只体检内参
  rosrun tly verify_camera_intrinsics.py _mode:=points _known_distance_m:=0.10
  rosrun tly verify_camera_intrinsics.py _mode:=aruco _marker_length_m:=0.05
